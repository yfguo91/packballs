...
/* Date:   09. jan. 2016                                                   */
/* Class:  Poi - Vector operations     Matrix - Vector operations        */
/* *************************************************************************/
  ...
  */
  ...
  //点加向量
  template <int D>
  inline Poi<D> operator+ (const Poi<D> & a, const Vec<D> & b)
  {
    Poi<D> res;
    for (int i = 0; i < D; i++)
      res(i) = a(i) + b(i);
  ...
  //两点相减得向量
  template <int D>
  inline Vec<D> operator- (const Poi<D> & a, const Poi<D> & b)
  {
    Vec<D> res;
    for (int i = 0; i < D; i++)
      res(i) = a(i) - b(i);
  ...
  //点加向量得点
  template <int D>
  inline Poi<D> & operator+= (Poi<D> & a, const Vec<D> & b)
  {
    for (int i = 0; i < D; i++)
      a(i) += b(i);
    return a;
  ...
  */
  ...
  template <int D>
  inline ostream & operator<< (ostream & ost, const Poi<D> & a)
  {
    ost << "(";
    for (int i = 0; i < D-1; i++)
      ost << a(i) << ", ";
  ...
  template <int D>
  inline ostream & operator<< (ostream & ost, const Bo<D> & b)
  {
    ost << b.PMin() << " - " << b.PMax();
    return ost;
  }
