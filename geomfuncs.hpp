...
/* Date:   09. jan. 2016                                                   */
/* Class: Poi Vec Mat Box BoxSphere                                      */
/* *************************************************************************/
  ...
  //两点的距离
  template <int D>
  inline double Dist (const Poi<D> & a, const Poi<D> & b)
  {
    return Abs (a-b);
  }
  //两点距离的平方
  template <int D>
  inline double Dist2 (const Poi<D> & a, const Poi<D> & b)
  {
    return Abs2 (a-b);
  }
  ...
  //两点的中心（函数重载）
  template <int D>
  inline Poi<D> Center (const Poi<D> & a, const Poi<D> & b)
  {
    Poi<D> res;
    for (int i = 0; i < D; i++)
      res(i) = 0.5 * (a(i) + b(i));
  ...
  //三点的中心（函数重载）
  template <int D>
  inline Poi<D> Center (const Poi<D> & a, const Poi<D> & b, const Poi<D> & c)
  {
    Poi<D> res;
    for (int i = 0; i < D; i++)
  ...
  //四点的中心（函数重载）
  template <int D>
  inline Poi<D> Center (const Poi<D> & a, const Poi<D> & b, const Poi<D> & c, const Poi<D> & d)
  {
    Poi<D> res;
    for (int i = 0; i < D; i++)
