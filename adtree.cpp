...
#include<algorithm>
  ...
  Poi3dTree :: Poi3dTree (const Poi<3> & pmin, const Poi<3> & pmax)
  {
	  double pmi[3], pma[3];
	  for (int i = 0; i < 3; i++)
	  {
  ...
  void Poi3dTree :: Insert (const Poi<3> & p, int pi)
  {
    double pd[3];
    pd[0] = p(0);
    pd[1] = p(1);
  ...
  void Poi3dTree :: GetIntersecting (const Poi<3> & pmin, const Poi<3> & pmax, vector<int> & pis) const
  {
	  double pmi[3], pma[3];
	  for (int i = 0; i < 3; i++)
	  {
 ...
 /* ******************************* Bo3dTree ******************************* */
  Bo3dTree :: Bo3dTree (const Bo<3> & abox)
  {
	  boxpmin = abox.PMin();
	  boxpmax = abox.PMax();
  ...
  Bo3dTree :: Bo3dTree (const Poi<3> & apmin, const Poi<3> & apmax)
  {
	  boxpmin = apmin;
	  boxpmax = apmax;
	  double tpmin[6], tpmax[6];
  ...
  void Bo3dTree :: Insert (const Poi<3> & bmin, const Poi<3> & bmax, int pi)
  {
	  double tp[6];
	  for (int i = 0; i < 3; i++)
	  {
  ...
  void Bo3dTree ::GetIntersecting (const Poi<3> & pmin, const Poi<3> & pmax, vector<int> & pis) const
  {
	  double tpmin[6];
	  double tpmax[6];
